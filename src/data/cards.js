...
const regularCards = [
  {
    ...
    yes: { people: +3, class: +10, idea: -5, intl: -10 }, // -2 net
    no:  { people: -10, class: -5, idea: +3, intl: +10 }  // -2 net
  },
  {
    faction: "👷 Công nhân",
    text: "Cần nâng lương và giảm giờ làm.",
    yes: { people: +10, class: +3, idea: -7, intl: -10 }, // -4 net
    no:  { people: -10, class: -7, idea: +3, intl: +10 }  // -4 net
  },
  {
    faction: "🎓 Trí thức",
    text: "Giáo dục phải được ưu tiên ngân sách.",
    yes: { people: +3, class: -10, idea: +10, intl: -7 }, // -4 net
    no:  { people: -7, class: +10, idea: -10, intl: +3 }  // -4 net
  },
  {
    faction: "🏭 Nhà máy",
    text: "Cần tăng ca sản xuất để đáp ứng nhu cầu.",
    yes: { people: -10, class: +9, idea: -5, intl: +5 }, // -1 net
    no:  { people: +9, class: -10, idea: +5, intl: -5 }  // -1 net
  },
  {
    faction: "🌾 Hợp tác xã",
  ...
  },
  {
    ...
    yes: { people: +3, class: -7, idea: +10, intl: -10 }, // -4 net
    no:  { people: -7, class: +3, idea: -10, intl: +10 }  // -4 net
  },
  {
    faction: "⚔️ Quân đội",
  ...
  },
  {
    ...
    yes: { people: +10, class: -7, idea: +3, intl: -10 }, // -4 net
    no:  { people: -10, class: +3, idea: -7, intl: +10 }  // -4 net
  },
  {
    faction: "👨‍⚕️ Y tế",
    text: "Cần mở rộng chăm sóc sức khỏe miễn phí.",
    yes: { people: +10, class: -10, idea: +3, intl: -7 }, // -4 net
    no:  { people: -10, class: +10, idea: -7, intl: +3 }  // -4 net
  },
  {
    faction: "🎭 Văn nghệ sĩ",
  ...
  },
  {
    ...
    yes: { people: -10, class: +3, idea: -3, intl: +10 }, // 0 net
    no:  { people: +10, class: -3, idea: +3, intl: -10 }  // 0 net
  },
  {
    faction: "🏫 Thanh niên",
    text: "Tổ chức phong trào thanh niên tình nguyện.",
    yes: { people: +3, class: +9, idea: -5, intl: -10 }, // -3 net
    no:  { people: -5, class: -10, idea: +3, intl: +9 }  // -3 net
  },
  {
    faction: "⛪ Tôn giáo",
    text: "Các tổ chức tôn giáo xin tự do hoạt động.",
    yes: { people: +10, class: -10, idea: -7, intl: +3 }, // -4 net
    no:  { people: -10, class: +10, idea: +3, intl: -7 }  // -4 net
  },
  {
    faction: "🚜 Máy móc",
    text: "Nhập khẩu máy móc hiện đại từ nước ngoài?",
    yes: { people: -7, class: +10, idea: -10, intl: +3 }, // -4 net
    no:  { people: +3, class: -10, idea: +10, intl: -7 }  // -4 net
  },
  {
    faction: "🌳 Môi trường",
  ...
  // Positive outcome cards (strategic opportunities)
  {
    ...
    yes: { people: +10, class: +7, idea: +5, intl: -8 }, // +14 net - rare win
    no:  { people: -7, class: -5, idea: -7, intl: +10 }   // -9 net
  },
  {
    faction: "🎯 Kế hoạch",
    text: "Thực hiện kế hoạch 5 năm phát triển kinh tế.",
    yes: { people: +7, class: +10, idea: +5, intl: -8 }, // +14 net - rare win
    no:  { people: -8, class: -10, idea: -5, intl: +7 }  // -16 net - harsh penalty
  },
  {
    faction: "📚 Văn hóa",
    text: "Phát động phong trào xóa mù chữ toàn quốc.",
    yes: { people: +10, class: +5, idea: +9, intl: -7 }, // +17 net - best card
    no:  { people: -7, class: -7, idea: -10, intl: +5 }   // -19 net
  }
];
...
const turnBasedEvents = [
  {
    ...
    yes: { people: +10, class: +7, idea: -5, intl: -10 }, // +2 net - positive!
    no:  { people: -10, class: -7, idea: +5, intl: +10 }  // -2 net
  },
  {
    turn: 10,
    faction: "🌾 Nạn đói",
    text: "Hạn hán ở miền Bắc. Mở kho dự trữ cứu đói?",
    yes: { people: +10, class: -10, idea: +3, intl: -7 }, // -4 net - hard choice
    no:  { people: -10, class: +9, idea: -5, intl: +5 }  // -1 net
  },
  {
    turn: 15,
    ...
    yes: { people: +3, class: -7, idea: -10, intl: +10 }, // -4 net
    no:  { people: -3, class: +5, idea: +10, intl: -10 }  // +2 net
  },
  {
    turn: 20,
    faction: "⚔️ Chiến tranh",
    text: "Thực dân Pháp tấn công. Tổng động viên?",
    yes: { people: -10, class: +10, idea: +7, intl: -9 }, // -2 net - important crisis
    no:  { people: +10, class: -10, idea: -5, intl: +5 }   // 0 net
  },
  {
    turn: 25,
    faction: "📜 Cải cách",
    text: "Đã 25 quyết sách. Tiến hành cải cách toàn diện?",
    yes: { people: +10, class: +9, idea: +5, intl: -10 }, // +14 net - big reward!
    no:  { people: -10, class: -7, idea: +3, intl: +10 }   // -4 net
  }
];
...
const thresholdEvents = [
  {
    ...
    yes: { people: +3, class: -7, idea: +10, intl: -10 }, // -4 net
    no:  { people: -3, class: +5, idea: -10, intl: +10 }  // +2 net - reward for high people
  },
  {
    ...
    yes: { people: +10, class: -10, idea: +3, intl: -7 }, // -4 net - crisis
    no:  { people: -10, class: +10, idea: -5, intl: +5 }  // 0 net
  },
  {
    id: "class_solidarity",
    ...
    yes: { people: +7, class: +10, idea: -5, intl: -10 }, // +2 net - reward!
    no:  { people: -7, class: -10, idea: +5, intl: +10 }  // -2 net
  },
  {
    id: "class_struggle",
    ...
    yes: { people: -7, class: +10, idea: +5, intl: -10 }, // -2 net
    no:  { people: +5, class: -10, idea: -5, intl: +10 }  // 0 net - crisis
  },
  {
    id: "ideological_peak",
    ...
    yes: { people: -5, class: +7, idea: +10, intl: -10 }, // +2 net - reward!
    no:  { people: +5, class: -7, idea: -10, intl: +10 }  // -2 net
  },
  {
    ...
    yes: { people: -10, class: +5, idea: +10, intl: -7 }, // -2 net - crisis
    no:  { people: +10, class: -7, idea: -10, intl: +5 }  // -2 net
  },
  {
    ...
    yes: { people: +7, class: -7, idea: -10, intl: +10 }, // 0 net - reward
    no:  { people: -5, class: +5, idea: +10, intl: -10 }  // 0 net
  },
  {
    id: "isolated",
    ...
    yes: { people: -7, class: -10, idea: +5, intl: +10 }, // -2 net - crisis
    no:  { people: +5, class: +10, idea: -7, intl: -10 }  // -2 net
  },
  {
    id: "balanced_state",
    condition: (stats) => {
